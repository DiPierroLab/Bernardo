...
# Example generated script produced from minimize_chromosome_configuration_source.py
# using run_many_minimize.sh.
#
# This file illustrates the structure of a generated FIRE minimization script
# for one input chromatin structure. It is included for documentation only;
# paths should be adapted before execution.
...
input_traj = 'input/REP1/eq_chr7_95.4-96.5_conf_0.pdb'
input_name = 'minimized_C_7_region_95.4-96.5_file_1_str_567'
...
data_dir = '/path/to/output_directory'
hoomd.md.integrate.mode_standard(dt=dt_for_langvd);
integrator = hoomd.md.integrate.langevin(group = all, kT = 1, seed=14210)
