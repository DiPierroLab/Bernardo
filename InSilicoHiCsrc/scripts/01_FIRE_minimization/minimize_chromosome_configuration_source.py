...
# Template script for FIRE energy minimization stage of the in-silico Hi-C pipeline.
# Placeholder variables beginning with "@" are replaced by the generator shell script
# to produce per-structure production scripts.
...
# Initialize HOOMD context (legacy API for HOOMD-blue v2.x)
...
# Save minimized structure for downstream MD crosslinking/digestion simulations.
