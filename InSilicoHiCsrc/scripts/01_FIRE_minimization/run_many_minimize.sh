#!/bin/bash
#
# Generate per-structure FIRE minimization scripts and Slurm submission files
# from templates.
#
# This script was used to generate production minimization runs. Paths and
