...
# Example generated script produced from chromosome_fix_chop_evolve_from_singlestr_source.py
# using run_chop_evolve_from_many_str.sh.
#
# This file illustrates the structure of a generated production script for
# one input chromatin structure and one random seed. It is included for
# documentation only; paths should be adapted before execution.
...
minimized_str_file = '/path/to/minimized_structures/minimized_C_7_region_95.4-96.5_file_9_str_997_minimized.gsd'
...
nc = 5400 # number of bonds to keep after chopping
...
integrator = hoomd.md.integrate.langevin(group = evolve_group, kT = 1, seed=13825)
...
hoomd.dump.gsd(output_dir+'/chromosome_crosslinked_fixed_chopped_'+fn_base+'.gsd', overwrite=True,  period=1000, group=all, phase=0)
