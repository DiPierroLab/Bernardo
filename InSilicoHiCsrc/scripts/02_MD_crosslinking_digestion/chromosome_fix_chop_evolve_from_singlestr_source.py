...
# Template script for the MD crosslinking/digestion stage of the in-silico Hi-C pipeline.
# Placeholder variables beginning with "@" are replaced by the generator shell script
# to produce per-structure/per-seed production scripts.
...
# Save metadata needed for downstream ligation analysis:
