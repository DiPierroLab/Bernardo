#!/bin/bash
#
# Generate per-structure MD simulation scripts and Slurm submission files
# from templates for the crosslinking/digestion stage of the in-silico Hi-C pipeline.
#
# This script was used to generate production runs. Paths and Slurm parameters
# should be adapted to the user's HPC system before execution.
#
...
cell_type=xx
region=95.4-96.5
nkeep=(500)  # chopped bonds = N_bonds - nkeep
