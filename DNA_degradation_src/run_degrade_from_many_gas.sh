...
dt=0.001
ncut=5499
nsteps=100000 #5000000 #100000 #10000000
nsteps_eq=0
ncycles=1
seed_number=$RANDOM
freq=50
...
cell_type=xx
region=95.4-96.5
#nkeep=(5000) #(4000 4500 3000) #(5400 5250 5000 4500 4000 3000) # chopped bonds = N_bonds - nkeep
input_dir='/work/dipierrolab/amit.das/dna_lig/chr7_95.4-96.5/minimized_str_files/data'
output_dir='/scratch/b.zubillagaherrera/woolly_init_chop_2/degrade_ncut_5500_finer/'
wallpos=300
...
runs_per_str=1
prev_run_per_str=0
njobs=$((5620*${runs_per_str}))
k=0
ll=1
jobname=chr_${c}'_region_'${region}'_degrade_multirun_list_'${ll}
